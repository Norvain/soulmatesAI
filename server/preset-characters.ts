...
export const PRESET_MAP: Record<string, PresetCharacter> = {
  ...
  preset_guchengze: {
    ...
    appearance:
      "26岁左右东亚男性，黑色短发利落干净、两侧鬓角分明，剑眉星目，眼神锐利深邃，深褐色瞳孔，鼻梁高挺，下颌线分明棱角清晰，薄唇紧抿带克制感，皮肤干净偏冷白，身高约185cm，肩宽背直、体型挺拔有力，气质冷峻克制带压迫感，永远身着剪裁合体的黑色或深灰色三件套西装、白衬衫与深色丝质领带，左腕戴黑色金属腕表，整体都市电影感，冷调高级灯光，低饱和、高对比、阴影锐利",
  },
  preset_shenzhiyi: {
    name: "沈知意",
